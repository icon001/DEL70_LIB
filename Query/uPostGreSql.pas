...
function TPostGreSql.SelectTB_CARDFromArmAreaGradeJoinBase(aAC_NODENO,
...
function TPostGreSql.SelectTB_CARDFromArmAreaGradeNotIn(aAC_NODENO,
  aAC_ECUID, aArmAreaNo: string): string;
var
  stSql : string;
begin
...
function TPostGreSql.SelectBuildingTB_ALARMEVENTFromArmAreaDayToDay(
  aFromDate, aToDate, aNodeNo, aEcuId, aArmAreaNo, aBuildingCode,
  aFloorCode, aAreaCode, aAlarmType: string;aPcTime:Boolean=False): string;
var
  stSql :string;
begin
  ...
  stSql := stSql + ' AND substr(a.AL_ZONENO,2,1) = j.AL_ZONENUM) ';
  stSql := stSql + ' Where a.GROUP_CODE = ''' + GROUPCODE + ''' ';
  if Not aPcTime then
  begin
    stSql := stSql + ' AND a.AL_DATE BETWEEN ''' + aFromDate
  ...
  begin
    stSql := stSql + ' AND substr(a.AL_INPUTTIME,1,8) BETWEEN ''' + aFromDate
                   + ''' AND ''' + aToDate + ''' ';
  end;
  if Trim(aNodeNo) <> '' then
  begin
...
function TPostGreSql.SelectTB_ARMAREAGRADEJoinBase(aBuildingCode,
  aFloorCode, aAreaCode, aCardNo, aArmAreaName: string): string;
var
  stSql : string;
begin
...
function TPostGreSql.selectTB_ARMAREAJoinAdmin(aBuildingCode, aFloorCode,
...
function TPostGreSql.selectTB_ARMAREAJoinPromiseCode(
  aPromisecode: string): string;
var
  stSql :string;
begin
...
function TPostGreSql.SelectTB_ALARMEVENT_ArmAreaFromDayToDay(aFromDate,
...
begin
  ...
  stSql := stSql + ' AND substr(a.AL_ZONENO,2,1) = g.AL_ZONENUM) ';
  stSql := stSql + ' Where a.GROUP_CODE = ''' + GROUPCODE + ''' ';
  if Not aPcTime then
  begin
    stSql := stSql + ' AND a.AL_DATE BETWEEN ''' + aFromDate
...
function TPostGreSql.AlterTB_ARMAREATelNo_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ARMAREAmemo_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.UpdateTB_ARMAREA_FromAlarmDeviceMemo: string;
var
  stSql : string;
begin
    ...
    stSql := stSql + ' AND TB_ARMAREA.AC_ECUID = TB_ALARMDEVICE.AC_ECUID ';
    stSql := stSql + ' ) ';
    stSql := stSql + ' where TB_ALARMDEVICE.GROUP_CODE = ''' + GROUPCODE + ''' ';
    result := stSql;
end;

function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm0_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm1_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm2_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm3_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm4_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm5_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm6_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm7_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISAlarm8_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISDoor3_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISDoor4_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISDoor5_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISDoor6_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISDoor7_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_HISDoor8_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm0_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm1_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm2_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm3_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm4_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm5_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm6_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm7_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEAlarm8_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEDoor3_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEDoor4_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEDoor5_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEDoor6_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEDoor7_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNO_PROMISEDoor8_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm0_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm1_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm2_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm3_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm4_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm5_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm6_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm7_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPAlarm8_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPDoor3_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPDoor4_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPDoor5_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPDoor6_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPDoor7_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DEVICECARDNOGROUPDoor8_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_EMPLOYEE_MASTER_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_SONGHOFDCONFIG: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_SEMESTER: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_FOODDayCount: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_FOODSemesterCount: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_FOODWeekCount: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_FOODCodeCount: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_EMPLOYEECHANGE: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ATWORKTYPE_ATSTARTBUTTON_Change: string;
var
  stSql : string;
begin
  stSql := 'alter table TB_ATWORKTYPE alter column  AW_ATSTARTBUTTON TYPE varchar(10) ';
  result := stSql;
end;

function TPostGreSql.AlterTB_ATWORKTYPE_ATOFFBUTTON_Change: string;
var
  stSql : string;
begin
  stSql := 'alter table TB_ATWORKTYPE alter column  AW_ATOFFBUTTON TYPE varchar(10) ';
  result := stSql;
end;

function TPostGreSql.AlterTB_ATWORKTYPE_WORKOUTBUTTON_Change: string;
var
  stSql : string;
begin
  stSql := 'alter table TB_ATWORKTYPE alter column  AW_WORKOUTBUTTON TYPE varchar(10) ';
  result := stSql;
end;

function TPostGreSql.AlterTB_ATWORKTYPE_WORKINBUTTON_Change: string;
var
  stSql : string;
begin
  stSql := 'alter table TB_ATWORKTYPE alter column  AW_WORKINBUTTON TYPE varchar(10) ';
  result := stSql;
end;

function TPostGreSql.AlterTB_EMPLOYEE_CAGROUP_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ACCESSDEVICE_MEMLOAD_ADD: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_DOOR_MEMLOAD_ADD: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ARMAREA_MEMLOAD_ADD: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_EMPLOYEE_EXPIREUSE_ADD: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_EMPLOYEEEXPIRECHANGE: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_EMPLOYEEEXPIRE_Trigger: Boolean;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_EMPLOYEE_CardChange_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_EMPLOYEE ADD EM_CARDCHANGE char(1) ';
  result := stSql;
end;

function TPostGreSql.AlterTB_EMPLOYEE_COTELENCRYPT_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.SelectTB_EMPLOYEEJoinATD2DState(aFromDate,
  aToDate: string): string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' CASE ';
  stsql := stSql + ' WHEN bb.HO_STATE = ''I'' OR aa.AT_WEEKCODE = ''1'' then 0 ';
  stSql := stSql + ' ELSE CAST((COALESCE(substring(aa.at_intime,9,2),''0'')) AS INTEGER) * 60 + CAST((COALESCE(substring(aa.at_intime,11,2),''0'')) AS INTEGER) ';
  stSql := stSql + ' END as intime, ';
  stSql := stSql + ' CASE ';
  stsql := stSql + ' WHEN bb.HO_STATE = ''I'' OR aa.AT_WEEKCODE = ''1'' then 0 ';
  stSql := stSql + ' ELSE CAST((COALESCE(substring(aa.at_outtime,9,2),''0'')) AS INTEGER) * 60 + CAST((COALESCE(substring(aa.at_outtime,11,2),''0'')) AS INTEGER) ';
  ...
  stSql := stSql + ' CASE ';
  stsql := stSql + ' WHEN bb.HO_STATE = ''I'' OR aa.AT_WEEKCODE = ''1'' then CAST((COALESCE(substring(aa.at_intime,9,2),''0'')) AS INTEGER) * 60 + CAST((COALESCE(substring(aa.at_intime,11,2),''0'')) AS INTEGER) ';
  stSql := stSql + ' ELSE 0 ';
  stSql := stSql + ' END as HOLIDAYINTIME, ';
  stSql := stSql + ' CASE ';
  stsql := stSql + ' WHEN bb.HO_STATE = ''I'' OR aa.AT_WEEKCODE = ''1'' then CAST((COALESCE(substring(aa.at_outtime,9,2),''0'')) AS INTEGER) * 60 + CAST((COALESCE(substring(aa.at_outtime,11,2),''0'')) AS INTEGER) ';
  stSql := stSql + ' ELSE 0 ';
...
function TPostGreSql.AlterTB_FINGERDEVICE_CHANGE_ADD: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ZONEDEVICE_ZONENUM_Change: string;
var
  stSql : string;
begin
  stSql := 'alter table TB_ZONEDEVICE alter column AL_ZONENUM TYPE varchar(2) ';
  result := stSql;

end;

function TPostGreSql.DropTB_ZONEDEVICE_PKIndex: string;
begin

end;

function TPostGreSql.AlterTB_ZONEDEVICE_PKIndexAdd: string;
begin

end;

function TPostGreSql.AlterTB_ZONEDEVICE_ZONEEXT_ADD: string;
var
  stSql : string;
begin
